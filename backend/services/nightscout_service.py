...
def get_nightscout_treatments(nightscout_url: str, api_token: str, count: int = 100) -> Optional[List[Treatment]]:
    """
    Fetches and validates treatments from the Nightscout API.

    Args:
        nightscout_url: The URL of the Nightscout instance.
        api_token: The API token for authentication.
        count: The number of treatments to fetch.
